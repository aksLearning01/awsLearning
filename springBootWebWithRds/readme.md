...
Run edu.aks.aws.SpringBootWebWithRdsApplication as a Java Application.
...
- `edu.aks.aws.security.SecurityConfiguration` contains the in memory security credential configuration.
